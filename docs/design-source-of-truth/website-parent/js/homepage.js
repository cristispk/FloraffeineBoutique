...
(0, _utils.preloadImages)('.slide__img').then(function () {
  ...
  if (!prefersReduced) {
    var AUTOPLAY_MS = 6000; // change speed as desired
    var autoplayId = null;
    ...
    startAutoplay();
    var hoverTargets = [document.querySelector('.slideshow'), document.querySelector('.slides-nav')].filter(Boolean);
    ...
    navigation.DOM.ctrls.next.addEventListener('click', startAutoplay);
    navigation.DOM.ctrls.prev.addEventListener('click', startAutoplay);
